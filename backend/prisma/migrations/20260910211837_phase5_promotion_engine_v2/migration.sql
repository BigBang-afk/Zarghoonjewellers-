...
CREATE TABLE "new_promotions" (
    ...
    "existingUsersOnly" BOOLEAN NOT NULL DEFAULT false,
    "minCompletedRides" INTEGER,
    "maxCompletedRides" INTEGER,
    "requiredAcquisitionSource" TEXT,
    "daysOfWeek" TEXT,
    "startHour" INTEGER,
    "endHour" INTEGER,
    "usageLimit" INTEGER,
...
INSERT INTO "new_promotions" ("campaignType", "cityId", "code", "createdAt", "createdById", "description", "discountType", "discountValue", "expiresAt", "id", "isActive", "maxDiscount", "minFare", "newUsersOnly", "startsAt", "updatedAt", "usageCount", "usageLimit", "vehicleTypeId") SELECT "campaignType", "cityId", "code", "createdAt", "createdById", "description", "discountType", "discountValue", "expiresAt", "id", "isActive", "maxDiscount", "minFare", "newUsersOnly", "startsAt", "updatedAt", "usageCount", "usageLimit", "vehicleTypeId" FROM "promotions";
