      ...
      <header className="sticky top-[41px] z-40 border-b border-ink-900/[0.06] bg-[#F6F5FB]/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/app"><Button variant="primary" size="sm" icon={<ArrowRight className="h-4 w-4" />} className="flex-row-reverse">Get the app</Button></Link>
          </div>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-7xl px-5">
          <Card className="grid items-center gap-8 overflow-hidden p-8 md:grid-cols-2 md:p-14">
            <div>
              ...
              <Link to="/driver" className="mt-6 inline-block">
